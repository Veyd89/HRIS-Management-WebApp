...
import BgAuth from "../components/fragments/BgAuth";
import Header from "../components/elements/Header";
import NavAuth from "../components/elements/NavAuth";
import Footer from "../components/elements/Footer";

const Test = () => {
  return (
    <section className="min-h-full box-border bg-gradient-to-tr from-[#DCE5F2] to-[#F1F4F9] relative w-full flex flex-col gap-12 justify-center items-center overflow-hidden py-10">
      <BgAuth type={"login"} />
